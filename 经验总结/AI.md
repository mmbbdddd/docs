...
但，AI技术发展很快，相对去年的我，对AI的看法已经有了很大转变，它需要密切保持观察和跟踪。
    
    逻辑上《人月神话》论定软件的本质是概念和概念之间关系（耦合）+变化，造成的指数级复杂度。
    从根本上降低复杂性的办法就是抽象，最少的概念，最少的关系，最少的变化。
    暂时看，AI只是一个效率工具、而不是归纳、抽象工具。
    至少从现阶段看，它数倍的提升了编码的效率，可是整体上软件工程的效率并没有提升。（很奇怪）
    so，从结果上看，也许cursor等的路子是对的。claudecode也许隐患很大，并不是长久的路子。
    可是，它当前惊人的进展，确实探索了AI可以呈现的极致能力边界。
    

# AI架构范式发展
 
    Prompt 工程：优化单次提问质量，人是每一轮操作者
    Context 工程：优化输入信息质量，管好上下文窗口
    Harness 工程：搭建基础设施（尤其是sandbox，feedback，结构化输出、校验、结果信号、护栏等机制）提升agent的能力和工作质量
    Loop Engine（循环工程）：Agent盯Agent，人兜底。既没法彻底解决Agent的工作质量，人也没法跟上Agent的效率。策略性的方法。

    从harness到loop engine，基本上就开始走控制论、系统论的路子了。用一堆不怎么可靠的组件，搭建高可靠的业务。
    再发展下去，已经没有什么理论可以指导它的发展了（数学、量子力学、软件的发展，都惊人的指向了不确定性、混沌，而复杂系统科学迄今依然没有什么奠基性、开创性的发展）
    从生物演化的历史、从复杂系统构造的研究看，唯一明确的是，复杂、不混沌、涌现的唯一途径。就是复杂系统有统一的、简洁优雅又高度复杂的原子结构。

 [领域驱动战术设计](./领域驱动战术设计.md)
